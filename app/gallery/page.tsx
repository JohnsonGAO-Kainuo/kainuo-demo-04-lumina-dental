    ...
    <div className="pt-32 pb-20 min-h-screen bg-[#FDFBF7]">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-32 grid md:grid-cols-3 gap-8">
           {[1,2,3].map((item) => (
             <div key={item} className="relative group overflow-hidden bg-white p-4 shadow-sm hover:shadow-xl transition-all duration-500">
               ...
               <h3 className="font-serif text-xl text-slate-800">Invisalign Correction</h3>
               <p className="text-slate-400 text-sm mt-1">12 months treatment</p>
             </div>
           ))}
        </div>
      </div>
